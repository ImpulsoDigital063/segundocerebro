...
**Outros dois achados registrados:**
- **Limite de profissional só é validado no client** (`ProfissionaisTab.tsx:56`). Não há checagem na rota de criar profissional — dá pra estourar o plano sem pagar. Hoje é teórico; no filtro dos 100 clientes é furo de receita.
...
- [ ] **Validação de limite de profissional só no client** (`ProfissionaisTab.tsx:56`) — sem checagem na rota. Dá pra estourar o plano sem pagar. Fechar antes de escalar
